...
React.render(
	React.createElement(Widget, {title: "This is my super widget"}),
...
},{"./widget/":2,"react":158}],2:[function(require,module,exports){
/**
 * External dependencies
 */
var React = require( 'react' );
...
Widget = React.createClass( {displayName: "Widget",
	...
	render: function() {
		return (
			React.createElement("div", {className: "widget widget__welcome"}, 
